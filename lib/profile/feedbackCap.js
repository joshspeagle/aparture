 ...
 * entries per type. Passes scoped-feedback and filter-override events through uncapped.
 * Reports trimming stats for user-facing transparency.
 *
...
export function applyCap(events, { commentCap = 30 } = {}) {
  ...
  return {
    ...
    stats: {
      ...
      scopedFeedback: scopedFeedback.length,
      filterOverride: filterOverrides.length,
