// Atom <entry> parser for the legacy /api/query path. Lifted verbatim from
// pipeline.js. Returns null for entries without an arXiv id (caller should
// skip them). See spec §4.5.
