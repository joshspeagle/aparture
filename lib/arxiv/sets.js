...
// arXiv archives that live under the OAI "physics" group. Membership here means
// the OAI set string is `physics:<archive>:<category>` (e.g. `physics:astro-ph:HE`)
// or `physics:<archive>` when the archive has no subcategory (e.g. `physics:hep-th`).
