...
// Opus/Sonnet 4.6 and later (including the 5.x line). It is NOT supported on
// Haiku (verified via live 400: "adaptive thinking is not supported on this
// model" against claude-haiku-4-5), and pre-4.6 Opus/Sonnet models
// (e.g. claude-opus-4-5, claude-sonnet-4-5, claude-opus-4-1) require the
// older `{type: 'enabled', budget_tokens}` shape and reject adaptive.
// Gate the thinking block on family AND version so every model the adapter
// might see gets a request shape its API accepts.
