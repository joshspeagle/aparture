...
function buildCachePrefix(scoringCriteria) {
  return `You are a research assistant scoring academic papers for relevance using a precise 0.0-10.0 scale. Please analyze this research paper and provide an updated assessment using a precise 0.0-10.0 scale.
...
/**
 * Per-call analysis instructions: output format specification.
 * Includes the originalScore which varies per paper.
 */
function buildAnalysisPrompt(originalScore) {
  return `Furthermore, now that you have access to the full paper, please provide:
