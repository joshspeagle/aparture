...
export default defineConfig({
  ...
  themeConfig: {
      ...
      '/using/': [
        {
          ...
          items: [
            ...
            { text: 'Tutorial: a week with the loop', link: '/using/feedback-loop-tutorial' },
        ...
        {
          text: 'Add-ons',
          items: [{ text: 'Generating a podcast', link: '/add-ons/podcast' }],
        },
      ],
      '/add-ons/': [
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/joshspeagle/aparture' }],
